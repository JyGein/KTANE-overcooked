...
public class Mixer : Station {
    ...
    private int _number;
    string[] unmixed = { "flour", "egg", "cutChocolate", "cutBlueberry", "cutStrawberry", "cutHoney", "cutCarrot" };
    string[] mixed = { "mixedFlour", "mixedEgg", "mixedChocolate", "mixedBlueberry", "mixedStrawberry", "mixedHoney", "mixedCarrot" };
